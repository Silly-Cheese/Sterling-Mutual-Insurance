...
function ClaimDetail({claim,staff,staffList,payments,onClose,patchClaim,assignClaim,referSIU,reload}){
  ...
  async function settleClaim(){
    ...
    if(amount>=10000&&!can(staff,PERMISSIONS.APPROVAL_MANAGE)){
      ...
      await patchClaim(claim,{status:"approval_pending",proposedSettlementAmount:amount},"settlement.approval.requested","Settlement sent for management approval");
      return;
    }
    await patchClaim(claim,{settlementAmount:amount,status:"settled",reserveAmount:0},"settlement.issued","Settlement issued");
  }
